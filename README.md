**Full Stack AI Engineer · UI/UX Designer · Graphic Designer**  
...
• CGPA: **3.34**  
• Achieved **Dean's List of Honours** four times  
...
- **Languages:** JavaScript, TypeScript, Python, Dart, SQL, HTML, CSS, C#, C++, Java, Bash, JSON, Kotlin, Ruby  
...
### Full Stack AI Engineer (Developer Lead) · Sunflower Care
- Developed and maintained a full-stack real-time communication platform  
- Built chat, group messaging, voice/video calls, notifications, file sharing, and encryption  
- Managed Kubernetes/Helm deployments, Ingress, TLS, databases, and DevOps automation

### Full Stack Engineer · Caritas
- Rebuilt and modernized the Caritas Online-Beratung platform with real-time chat and video/voice calls  
- Built features using React, Spring Boot, Java, Matrix/Synapse, Redis, MariaDB, and Kubernetes  
- Implemented multi-tenant architecture, role-based access, and encryption

### Full Stack Engineer (Intern) · Vaival Technologies
- Developed web applications using React, Node.js, Python, and SQL/NoSQL databases  
- Built REST APIs, frontend interfaces, and backend services

### Design & Animation Lead · IEEE ICIT Conference 2025
- Led complete motion and visual branding across 10+ digital assets  
- Produced animations, banners, badges, and digital content for IEEE

### Design Head · Daira 2025 Olympiad
- Directed design campaigns for a 5,000+ participant event  
...
- Led a 20+ member team for all university design projects  
...
- **Design Head, Daira 2025 Olympiad**  
  Recognized for outstanding leadership and creative contribution  
